# -*- coding: utf-8 -*-
"""
Created on Tue Nov 26 18:06:12 2019
...
from Env_agent_exploration_Sumo.agents.ql_agent import QLAgent
from Env_agent_exploration_Sumo.exploration.epsilon_greedy import EpsilonGreedy
...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='./Net/trips.trips.xml', help="Route definition xml file.\n")
    prs.add_argument("-a", dest="alpha", type=float, default=0.1, required=False, help="Alpha learning rate.\n")
    prs.add_argument("-g", dest="gamma", type=float, default=0.79, required=False, help="Gamma discount rate.\n")
...
#    experiment_time = str(datetime.now()).split('.')[0]
    out_csv = './Reinforcement Learning/Ql/Outputs/alpha{}_gamma{}_eps{}_decay{}_reward{}'.format( args.alpha, args.gamma, args.epsilon, args.decay, args.reward)

    env = SumoEnvironment(net_file='./Net/simple.net.xml',
